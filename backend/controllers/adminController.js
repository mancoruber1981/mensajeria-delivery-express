...
   const workbook = new ExcelJS.Workbook();
    ...
    // ✨ LÍNEA RESTAURADA: Calculamos el total de servicios ANTES de usarlo.
    const totalBrutoServicios = timeLogs.reduce((acc, log) => acc + log.valorNetoFinal, 0);

    // 1. Buscamos TODOS los préstamos aprobados del empleado usando .find()
    ...
    // 3. El resto del cálculo ahora funcionará porque 'totalBrutoServicios' existe
